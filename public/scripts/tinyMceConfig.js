tinyMCE.init({
	...
	plugins					: 'advlist, charmap, code, fullscreen, hr, image, insertdatetime, link, lists, media, paste, preview, print, searchreplace, table, textcolor, wordcount, filemanager',
