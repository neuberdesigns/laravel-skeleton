...
$envConfigs = array(
	'default'=>array('base'=>'', 'backdirs'=>4),
	'localhost'=>array('base'=>'/project-name/laravel/public', 'backdirs'=>5),
	'nibler.com.br'=>array('base'=>'/client/project-name/laravel/public', 'backdirs'=>5),
);
$envConfig = $envConfigs['default'];
if(array_key_exists(HOST, $envConfigs)){
	$envConfig = $envConfigs[HOST];
}

$base_url ="http://".HOST.$envConfig['base'];  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/uploads/tinymce_uploads/'; // path from base_url to base of upload folder (with start and final /)

$backDirs = str_repeat('../', $envConfig['backdirs']);
$current_path = $backDirs.'uploads/tinymce_uploads/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $backDirs.'uploads/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
